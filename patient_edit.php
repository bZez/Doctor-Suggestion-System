<h2 style="text-align: center">Edit your records</h2>
...
if(isset($_POST["Edit"])){
	...
	$query=mysql_query("UPDATE students SET name='$name',age='$age',sex='$sex',phone='$phone',problem='$problem' WHERE id=$id");
	if($query){echo "<center>Records edited</center>";}else{echo "Sorry! Failed!";}
